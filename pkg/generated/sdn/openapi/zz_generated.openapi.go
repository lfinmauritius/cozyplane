...
func schema_cozyplane_api_sdn_v1alpha1_FloatingIP(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.FloatingIPSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.FloatingIPStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.FloatingIPSpec", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.FloatingIPStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_FloatingIPList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "FloatingIPList contains a list of FloatingIP.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.FloatingIP"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.FloatingIP", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_FloatingIPSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "FloatingIPSpec binds one externally-routable address 1:1 to a workload inside a VPC. The address is reachable bidirectionally: inbound connections DNAT to the target, and the target's egress is SNATed from the floating address.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"vpcRef": {
						SchemaProps: spec.SchemaProps{
							Description: "VPCRef is the VPC the target lives in — it is in the same namespace as this object.",
							Default:     map[string]interface{}{},
					...
					"target": {
						SchemaProps: spec.SchemaProps{
							Description: "Target is the tenant IP within the VPC that the floating address binds to.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_cozyplane_api_sdn_v1alpha1_FloatingIPStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"address": {
						SchemaProps: spec.SchemaProps{
							Description: "Address is the externally-routable address assigned to this binding.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"phase": {
						SchemaProps: spec.SchemaProps{
							Description: "Phase is the current lifecycle phase of the FloatingIP.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_cozyplane_api_sdn_v1alpha1_LocalVPCRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "LocalVPCRef references a VPC in the same namespace as the referring object.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "Name is the VPC name within the referring object's namespace.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_cozyplane_api_sdn_v1alpha1_Port(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.PortStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.PortSpec", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.PortStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}
...
func schema_cozyplane_api_sdn_v1alpha1_PortSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PortSpec is the realized network interface of a pod on a VPC.\n\nA Port is cluster-scoped and its name encodes the VPC's VNI and the IP (v<vni>.<ip-with-dashes>), so creating it is an atomic claim on that IP within the VPC — etcd name uniqueness serializes concurrent allocators. The VNI is globally unique, so the name stays unique even though VPCs are namespaced.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"vpcRef": {
						SchemaProps: spec.SchemaProps{
							Description: "VPCRef identifies the VPC this port belongs to (owner namespace + name).",
							Default:     map[string]interface{}{},
...
func schema_cozyplane_api_sdn_v1alpha1_PortStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "PortStatus is the controller-observed state of a Port.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"groups": {
						VendorExtensible: spec.VendorExtensible{
...
func schema_cozyplane_api_sdn_v1alpha1_SecurityGroup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SecurityGroup is intra-VPC network policy, AWS-security-group-shaped: it selects member pods by label and admits inbound traffic from other groups (in the same VPC) or from north-south CIDRs. While no group selects a pod its intra-VPC ingress is unrestricted (today's behavior); once any group selects it, its ingress is default-deny, opened only by the union of its groups' rules. Enforcement is destination-side in the eBPF datapath, so it is placement-independent.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupSpec", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_SecurityGroupEgressRule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SecurityGroupEgressRule admits traffic from the group's members to a destination, optionally narrowed to specific ports.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"to": {
						SchemaProps: spec.SchemaProps{
							Description: "To is the admitted destination (a group, optionally in a peered VPC).",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupPeer"),
						},
					},
					"ports": {
						VendorExtensible: spec.VendorExtensible{
						...
						SchemaProps: spec.SchemaProps{
							Description: "Ports narrows the rule to specific destination ports. Empty means every port and protocol.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupPort"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupPeer", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupPort"},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_SecurityGroupList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SecurityGroupList contains a list of SecurityGroup.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroup", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_SecurityGroupPeer(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"cidr": {
						SchemaProps: spec.SchemaProps{
							Description: "CIDR admits north-south (bridge/floating) callers by their pre-masquerade client address. It does not match intra-VPC sources — those are identified by group. FQDN sources are a later increment.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_cozyplane_api_sdn_v1alpha1_SecurityGroupPort(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SecurityGroupPort is a protocol/port an ingress rule admits.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"protocol": {
						SchemaProps: spec.SchemaProps{
...
func schema_cozyplane_api_sdn_v1alpha1_SecurityGroupRule(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SecurityGroupRule admits traffic from one source to the group's members, optionally narrowed to specific ports.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"from": {
						SchemaProps: spec.SchemaProps{
							Description: "From is the admitted source.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupPeer"),
						},
					},
...
func schema_cozyplane_api_sdn_v1alpha1_SecurityGroupSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SecurityGroupSpec declares an intra-VPC policy group: which ports are members and, for a member, which sources may reach it.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"vpcRef": {
						SchemaProps: spec.SchemaProps{
							Description: "VPCRef is the local VPC — it lives in the same namespace as this object, like VPCPeering. A group belongs to exactly one VPC.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.LocalVPCRef"),
						},
					},
					"podSelector": {
						SchemaProps: spec.SchemaProps{
							Description: "PodSelector selects the member pods by their labels (evaluated at Port claim time — see the controller). An empty selector selects every pod in the VPC.",
							Default:     map[string]interface{}{},
							Ref:         ref(v1.LabelSelector{}.OpenAPIModelName()),
						},
					},
					"ingress": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Ingress is the list of allowed inbound sources. When *any* group selects a pod, that pod's ingress becomes default-deny and is opened only by the union of the ingress rules of the groups it belongs to.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupRule"),
									},
								},
							},
						},
					...
					"egress": {
						...
						SchemaProps: spec.SchemaProps{
							Description: "Egress is the list of allowed east-west destinations (the mirror of Ingress). When any group selects a pod, its east-west egress is also default-deny: it may reach another VPC pod only if a group it belongs to admits that pod's group here. A flow is delivered only when both the destination's ingress and the source's egress admit it. `to.cidr` (north-south/external egress) is a later increment.",
							Type:        []string{"array"},
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupEgressRule"),
									},
								},
							},
						},
				...
				Required: []string{"vpcRef", "podSelector"},
			},
		},
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.LocalVPCRef", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupEgressRule", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.SecurityGroupRule", v1.LabelSelector{}.OpenAPIModelName()},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_SecurityGroupStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "SecurityGroupStatus is the observed state of a SecurityGroup.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"id": {
						SchemaProps: spec.SchemaProps{
							Description: "ID is the per-VPC numeric identity (1..63), allocated by the controller — the wire identity the datapath keys on. Zero means unallocated.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_cozyplane_api_sdn_v1alpha1_VPC(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPC is a tenant overlay network. It is namespaced: the namespace expresses ownership. A pod's *use* of a VPC is granted separately by a VPCBinding, even within the owner's own namespace.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCSpec", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_VPCBinding(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPCBinding grants pods in its own (consumer) namespace permission to attach to the VPC named in spec.vpcRef. It is created by the VPC owner reaching into the consumer namespace (gated by RBAC create here + an export SAR on the VPC), and its existence is the namespace-keyed, datapath-readable authorization the CNI checks at attach time. A VPC's namespace expresses ownership; a VPCBinding expresses use — required even when the pod and VPC share a namespace.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCBindingSpec"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCBindingSpec", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_VPCBindingList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPCBindingList contains a list of VPCBinding.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCBinding"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCBinding", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_VPCBindingSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPCBindingSpec authorizes pods in the binding's (consumer) namespace to attach to the referenced VPC.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"vpcRef": {
						SchemaProps: spec.SchemaProps{
...
func schema_cozyplane_api_sdn_v1alpha1_VPCList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPCList contains a list of VPC.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPC"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPC", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_VPCPeering(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPCPeering is one half of a symmetric peering between two VPCs. Each owner creates a half in its own namespace (spec.vpcRef = its VPC, spec.peerRef = the other); the peering is live only while both halves exist and reference each other. Reciprocity is the consent — there is no accept step — and either side revokes unilaterally by deleting its half. Peered traffic is routed natively (no NAT), so the two VPCs' CIDRs must not overlap.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCPeeringSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCPeeringStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCPeeringSpec", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCPeeringStatus", v1.ObjectMeta{}.OpenAPIModelName()},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_VPCPeeringList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPCPeeringList contains a list of VPCPeering.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"kind": {
						SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCPeering"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCPeering", v1.ListMeta{}.OpenAPIModelName()},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_VPCPeeringSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPCPeeringSpec declares one half of a peering between two VPCs.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"vpcRef": {
						SchemaProps: spec.SchemaProps{
							Description: "VPCRef is the local VPC — it lives in the same namespace as this object.",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.LocalVPCRef"),
						},
					},
					"peerRef": {
						SchemaProps: spec.SchemaProps{
							Description: "PeerRef is the remote VPC (owner namespace + name).",
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCRef"),
						},
					},
				},
				Required: []string{"vpcRef", "peerRef"},
			},
		},
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.LocalVPCRef", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPCRef"},
	}
}

func schema_cozyplane_api_sdn_v1alpha1_VPCPeeringStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"phase": {
						SchemaProps: spec.SchemaProps{
							Description: "Phase is the current lifecycle phase of the peering.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
					"peerVNI": {
						SchemaProps: spec.SchemaProps{
							Description: "PeerVNI is the VNI of the peer VPC, once known.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_cozyplane_api_sdn_v1alpha1_VPCRef(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPCRef references a VPC by namespace and name. The namespace is the VPC owner's namespace, not necessarily the referrer's.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"namespace": {
						SchemaProps: spec.SchemaProps{
					...
					"name": {
						SchemaProps: spec.SchemaProps{
							Description: "Name is the VPC name within that namespace.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_cozyplane_api_sdn_v1alpha1_VPCSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPCSpec is the specification of a VPC — a tenant overlay network.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"cidrs": {
						SchemaProps: spec.SchemaProps{
					...
					"mtu": {
						SchemaProps: spec.SchemaProps{
							Description: "MTU is the MTU advertised to ports in this VPC. Zero selects the controller default.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
...
func schema_cozyplane_api_sdn_v1alpha1_VPCStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"vni": {
						SchemaProps: spec.SchemaProps{
							Description: "VNI is the overlay network identifier allocated to this VPC by the controller. Zero means unallocated.",
							Type:        []string{"integer"},
							Format:      "int32",
						},
					},
					"phase": {
						SchemaProps: spec.SchemaProps{
							Description: "Phase is the current lifecycle phase of the VPC.",
							Type:        []string{"string"},
							Format:      "",
						},
					},
...
func schema_cozyplane_api_sdn_v1alpha1_VPNConnectionIPsecAuth(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "VPNConnectionIPsecAuth configures IPsec peer authentication. PSK first; cert auth is a later increment.",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"pskSecretRef": {
						SchemaProps: spec.SchemaProps{
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"peerPublicKey": {
						SchemaProps: spec.SchemaProps{
							Description: "PeerPublicKey is the remote peer's WireGuard public key.",
							Default:     "",
							Type:        []string{"string"},
							Format:      "",
						},
...
func schema_cozyplane_api_sdn_v1alpha1_VPNGatewaySpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.LocalVPCRef", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPNExternalAddress", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPNGatewayIPsec", "github.com/lllamnyp/cozyplane/api/sdn/v1alpha1.VPNGatewayWireGuard"},
	}
}
